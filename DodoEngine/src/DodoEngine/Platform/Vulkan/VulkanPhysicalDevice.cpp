...
VkFormatProperties VulkanPhysicalDevice::GetFormatProperties(VkFormat _format) const {
  VkFormatProperties formatProperties;
  vkGetPhysicalDeviceFormatProperties(m_VkPhysicalDevice, _format, &formatProperties);
